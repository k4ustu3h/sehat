...
import k4ustu3h.sehat.extension.formatDuration
import k4ustu3h.sehat.util.formatDurationText
        ...
        DatePickerDialog(
            ...
            DateRangePicker(
                ...
                headline = {
                    if (dateRangePickerState.selectedStartDateMillis != null && dateRangePickerState.selectedEndDateMillis != null) {
                        val duration =
                            dateRangePickerState.selectedStartDateMillis!!.formatDuration(
                                    dateRangePickerState.selectedEndDateMillis!!
                                )
                        Text(
